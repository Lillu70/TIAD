...
Here is how to do it:
 ...
 - Option A) Simply search for "x64 Native Tools Command Prompt" Your instaled version should popup. Run that.
 ...
 - Run said "Build.bat" or "Optbuild.bat" for some o2 fun. This will create a new folder called "bin" that will house the executable.
